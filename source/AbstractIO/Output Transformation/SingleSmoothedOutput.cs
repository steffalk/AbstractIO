...
{
    /// <summary>
    /// An <see cref="ISingleOutput"/> which lets a target <see cref="ISingleOutput"/> smoothly approach a target value.
    /// </summary>
    /// <remarks>
    ...
    public class SingleSmoothedOutput : ISingleOutput, ITargetReachedObservable
    {
        ...
        private float _valueChangePerTick;
        ...
        {
            float currentValue = _targetOutput.Value;
            ...
            else
            {
                ...
                float newValue = _startValue + (DateTime.UtcNow.Ticks - _startTimeTicks) * _signedValuePerTick;
