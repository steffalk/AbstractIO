namespace AbstractIO
{
    ...
    /// </remarks>
    public delegate void SingleValueChangedHandler(object sender, float newValue);

    /// <summary>
    /// An interface for <see cref="ISingleInput"/> classes that can raise an event when the Value property changed.
    /// </summary>
    /// <remarks>
    /// This interface is intended, for example, for inputs which can react with an IRQ on changes and raise an event
    /// when this happens.
    /// </remarks>
    public interface IObservableSingleInput : ISingleInput
    {
        /// <summary>
        ...
        /// </remarks>
        event SingleValueChangedHandler ValueChanged;
    }
}
