...
{
    /// <summary>
    /// A class mapping an <see cref="ISingleInput"/> to an <see cref="IBooleanInput"/> using a threshold value.
    /// </summary>
    public class SingleSchmittTriggerInput : IBooleanInput
    {
        private ISingleInput _sourceInput;
        private float _lowThreshold, _highThreshold;
        bool _currentValue;
        ...
        public bool Value
        {
            get
            {
                ...
                float sourceValue = _sourceInput.Value;
