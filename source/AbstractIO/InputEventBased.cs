...
namespace AbstractIO
{
    ...
    /// </remarks>
    public delegate void BooleanValueChangedHandler(object sender, bool newValue);

    /// <summary>
    /// An interface for <see cref="IBooleanInput"/> classes that can raise an event when the Value property changed.
    /// </summary>
    /// <remarks>
    /// This interface is intended, for example, for inputs which can react with an IRQ on changes and raise an event
    /// when this happens.
    /// </remarks>
    public interface IObservableBooleanInput : IBooleanInput
    {
        /// <summary>
        ...
        /// </remarks>
        event BooleanValueChangedHandler ValueChanged;
    }
    ...
    /// collections even if the event fires many times rapidly.
    /// </remarks>
    public delegate void DoubleValueChangedHandler(object sender, double newValue);

    /// <summary>
    /// An interface for <see cref="IDoubleInput"/> classes that can raise an event when the Value property changed.
    /// </summary>
    /// <remarks>
    /// This interface is intended, for example, for inputs which can react with an IRQ on changes and raise an event
    /// when this happens.
    /// </remarks>
    public interface IObservableDoubleInput : IDoubleInput
    {
        /// <summary>
        /// This event gets fired when the Value property of the abstract input/output interfaces has changed.
        /// </summary>
