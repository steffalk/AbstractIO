...
{
    /// <summary>
    /// An <see cref="IObservableIntegerInput"/> whose value can be freely set.
    /// </summary>
    public class SettableIntegerInput : IObservableIntegerInput
    {
        private int _value;
        ...
        /// </remarks>
        public event IntegerValueChangedHandler ValueChanged;
        ...
        /// </remarks>
        public SettableIntegerInput(int initialValue)
        {
            _value = initialValue;
        }
