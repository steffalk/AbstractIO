...
{
    /// <summary>
    /// An <see cref="IObservableSingleInput"/> whose value can be freely set.
    /// </summary>
    public class SingleSettableInput : IObservableSingleInput
    {
        ...
        /// </remarks>
        public event SingleValueChangedHandler ValueChanged;
        ...
        /// </remarks>
        public SingleSettableInput(float initialValue)
        {
            _value = initialValue;
        }
